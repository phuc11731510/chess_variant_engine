...
class SearchWorker {
 ...
 private:
  ...
  struct TaskWorkspace {
    ...
    TaskWorkspace(TaskWorkspace&&) noexcept = default;
    TaskWorkspace& operator=(TaskWorkspace&&) noexcept = default;
    TaskWorkspace(const TaskWorkspace&) = delete;
    TaskWorkspace& operator=(const TaskWorkspace&) = delete;
  };
