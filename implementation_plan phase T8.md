...
**Mức độ đóng gói sẵn** (combo `Skill`, T8.x): Dễ=`Visits 80,Temperature 300`; Vừa=`Visits 400`; Khó=`Visits 1600`.
...
| **T8.x** (sau) | `--play` ASCII; combo `Skill`; tái dùng cây giữa nước; `mate`; tinh chỉnh time-control | Tiện ích/đánh bóng, không chặn bản dùng được. |
...
6. **T8.x**: `--play` ASCII, combo `Skill`, tái dùng cây, mate, tinh chỉnh time-control.
